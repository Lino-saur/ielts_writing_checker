...
- [ ] 6. Reduce energy-confirmation friction by showing cost and remaining balance on the primary action, reserving confirmation for exceptional cases.
- [ ] 7. Strengthen result hierarchy with target-gap context, the top three actions, and a prominent “start revising” action.
- [ ] 8. Simplify navigation into direct Review / Practice / History destinations and fix localized active-route highlighting.
- [ ] 9. Close the learning loop between practice and history with search, reset filters, practiced state, retry, rewrite, and target-score comparison.
- [ ] 10. Complete accessibility behavior for dialogs, tabs, focus management, Escape, and keyboard menu navigation.
